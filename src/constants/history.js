...
export const TYPE_MAP = {
  ...
  STOCKTAKE: { text: "STOCKTAKE", color: "brown" },
  STOCKTAKE_MISSING: { text: "STOCKTAKE_MISSING", color: "brown" },
  STOCKTAKE_FOUND: { text: "STOCKTAKE_FOUND", color: "brown" },
};
